...
Question.create(value: 1, description: '¿Si tengo 🍎🍎 y me regalan otras 🍎🍎, cuántas manzanas tengo ahora?', nivel_q: 1,
                topic_id: 1)
Question.create(value: 1, description: 'Si en un juego hay 👾👾 y estos llaman a 👾👾 👾👾 👾👾 👾👾 más, ¿cuántos hay ahora?',
                nivel_q: 1, topic_id: 1)
Question.create(value: 1,
                description: 'En un acuario viven 10 🐟, en otro 5 🐠 y otro 2 🐡, ¿cuántos peces hay si sumamos los 3 acuarios?', nivel_q: 1, topic_id: 1)
Question.create(value: 1,
...
Question.create(value: 1, description: 'Si tienes 10 manzanas y le das 3 a un amigo, ¿cuántas manzanas te quedan?',
                nivel_q: 1, topic_id: 2)
Question.create(value: 1,
                description: 'En un partido de fútbol, un equipo anotó 3 goles y le anularon 2 ¿Cuántos goles anotó en total?', nivel_q: 3, topic_id: 2)
...
Question.create(value: 3,
                description: 'Si tenías $500 en tu cuenta bancaria y realizaste un retiro de $215, ¿cuánto dinero te queda?', nivel_q: 2, topic_id: 2)
Question.create(value: 3,
                description: 'Si tenías 275 galletas en un frasco y comiste 128, ¿cuántas galletas te quedan?', nivel_q: 2, topic_id: 2)
Question.create(value: 3,
                description: 'Si tenías 890 páginas para leer en un libro y ya has leído 437, ¿cuántas páginas te quedan por leer?', nivel_q: 2, topic_id: 2)
Question.create(value: 3, description: 'Si tenías 780 fichas en un juego y perdiste 256, ¿cuántas fichas te quedan?',
                nivel_q: 2, topic_id: 2)
Question.create(value: 3,
...
## nivel 3
Question.create(value: 5, description: 'Si tienes 15 manzanas y le das 6 a tu amigo, ¿cuántas manzanas te quedan?',
                nivel_q: 3, topic_id: 2)
Question.create(value: 5, description: 'Si tienes $50 y compras un libro que cuesta $12, ¿cuánto dinero te queda?',
                nivel_q: 3, topic_id: 2)
Question.create(value: 5, description: 'Si tenías 250 lápices y pierdes 11, ¿cuántos lápices te quedan?', nivel_q: 3,
                topic_id: 2)
Question.create(value: 5, description: 'Si tenías $100 en tu billetera y gastaste $35, ¿cuánto dinero te queda?',
                nivel_q: 1, topic_id: 2)
Question.create(value: 5,
                description: 'Si tienes un $1000 pesos en tu billetera y compras un jugete con valor de $500 pesos, ¿cuántas dinero te queda?', nivel_q: 3, topic_id: 2)
Question.create(value: 5,
                description: 'Si tienes 30 juguetes y regalas 5 juguetes a cada uno de tus 4 amigos, ¿cuántos juguetes te quedan?', nivel_q: 3, topic_id: 2)
...
Question.create(value: 1,
                description: 'Si tienes 8 amigos y cada uno de ellos tiene 3 caramelos, ¿cuántos caramelos hay en total? ', nivel_q: 1, topic_id: 3)
Question.create(value: 1,
                description: 'Si tienes 10 billetes de $20 y 5 monedas de $1, ¿cuánto dinero tienes en total?', nivel_q: 1, topic_id: 3)
...
Achievement.create(name: '3̵̠̟͇͑̿͘3̸̻̺̦͒͛̀3̴̺͑͊͜͜͝3̴̡̢̦̓͌͘3̴̡̠͚͋̐̕3̵̘͎̪̿̈́͋3̴͔͉͔͑̈́3̵̼̠̙́̈́̚3̵͔̦̒͒̕',
                   description: '333', point: 33)
